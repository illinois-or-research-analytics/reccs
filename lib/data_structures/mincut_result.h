...
public:
    ...
    std::vector<uint32_t> get_light_partition() { return light_partition; }
    std::vector<uint32_t> get_heavy_partition() { return heavy_partition; }
    uint32_t get_cut_size() { return cut_size; }
};
