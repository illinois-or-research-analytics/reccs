...
#SBATCH --partition=folkvangr			## queue
#SBATCH --output=reccs_test_cit_full2.out		## file that will receive output from execution
#SBATCH --error=reccs_test_cit_full2.err		## file that will receive any error messages
